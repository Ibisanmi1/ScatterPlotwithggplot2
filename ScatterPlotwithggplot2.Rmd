...
# Save the plot
ggsave("images/EGFRplot.png", plot, width = 8, height = 6, dpi = 300)
...
IGFRplot <- ggplot(data, aes(x = MMGBSA, y = DOCK_SCORES)) +
  ...
  labs(
    x = "MMGBSA (ΔGbind) ",
    y = "Docking Scores (kcal/mol) ",
    title = "                                                   Binding Free Energy vs Docking Scores (IGF1R)",
    caption = "Data Source: IGF1R"
  ) +
  theme_minimal() +
  theme(
    plot.title = element_text(size = 16, face = "bold"),
...
# Save the plot
ggsave("images/IGFRplot.png", plot, width = 8, height = 6, dpi = 300)
...
# Save the plot
ggsave("ESRplot.png", plot, width = 8, height = 6, dpi = 300)
print(ESRplot)
...
# Save the plot
ggsave("PGRplot.png", plot, width = 8, height = 6, dpi = 300)
print(PGRplot)
...
# Save the plot
ggsave("YAP1plot.png", plot, width = 8, height = 6, dpi = 300)
print(YAP1plot)
